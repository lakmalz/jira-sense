...
class JiraSearchBuilder:
    ...
    def __init__(self, db_path: str = "./chromadb", collection_name: str = "jira_content"):
        """
...
if __name__ == "__main__":
    ...
    print("Initializing Jira Search Builder...")
    searcher = JiraSearchBuilder(db_path="./chromadb", collection_name="jira_content")
